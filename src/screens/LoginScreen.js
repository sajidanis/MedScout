...
const LoginScreen = () => {
  ...
  const redirect = sp.get('redirect') || '/user-dashboard';
    ...
    <section className="bg-gray-50">
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <Link href="/" className="flex items-center justify-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
                <img src="../images/MedScout.png" alt="Med Scout Logo" className="logo-img"></img>
                {/* <!-- <img className="w-8 h-8 mr-2" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/logo.svg" alt="logo">
                Med Scout     --> */}
            </Link>
            <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-bookmark-purple dark:border-gray-700">
                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <div className="space-y-4 md:space-y-6">
                        ...
                        <button onClick={getLoginData} className="w-full text-white focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 bg-bookmark-red text-white rounded-md px-7 py-3 uppercase">Sign in</button>
